...
public class DeptServiceImpl implements DeptService{
	 ...
	 */
	public long updateDeptById(Dept dept) {
		Dept oriDept = getDeptById(dept.getId());
		dept.setAddTime(oriDept.getAddTime());
		return deptDao.updateById(dept);
	}

	/* (non-Javadoc)
	 * @see com.mtea.yunwu.service.DeptService#searchPage(int, com.mtea.yunwu.model.core.Dept)
	 */
	@Override
	public Pager<Dept> searchPage(int page, Dept dept) {
		return deptDao.findPage(page,dept);
	}
